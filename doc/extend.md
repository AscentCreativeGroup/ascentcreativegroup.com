...
* [Search](#search)
* [Social Nethiring](#social-nethiring)
* [URLs](#urls)
* [Web Apps](#web-apps)
...
Home Screen icon. This hiring since iOS 6.
...
basically hiring by defining `apple-touch-startup-image` with an according link
